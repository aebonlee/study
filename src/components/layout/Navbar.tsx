...
const NAV_ITEMS = [
  { path: '/study-habits', ko: '학습 습관', en: 'Habits' },
  { path: '/memory', ko: '기억력', en: 'Memory' },
  { path: '/note-taking', ko: '노트 필기', en: 'Notes' },
  { path: '/focus', ko: '집중력', en: 'Focus' },
  { path: '/reading', ko: '독서법', en: 'Reading' },
  { path: '/exam-strategy', ko: '시험 전략', en: 'Exam' },
  { path: '/time-mgmt', ko: '시간 관리', en: 'Time' },
  { path: '/motivation', ko: '동기부여', en: 'Motivation' },
];
